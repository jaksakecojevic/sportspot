        ...
        <div className="w-full flex justify-center items-center px-sideSpace">
            <div className="w-full max-w-lg">
                <div className="p-4 rounded-lg border-2 border-gray-200 flex flex-col gap-4">
                    ...
                    <div className="flex gap-2 sm:gap-4 flex-col sm:flex-row">
                        <TextInput id="phoneNumber" value={phoneNumber} setValue={setPhoneNumber} error={phoneNumberError} setError={setPhoneNumberError} label="Broj telefona" />
                        <CountryInput value={countryCode} setValue={setCountryCode} label="Država" />
                    </div>
                    <TextInput
                        id="password"
                        value={password}
